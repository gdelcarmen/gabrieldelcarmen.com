...
const ContactSection = ({ isVisible }: SectionProps) => (
  ...
  >
    ...
    <div className="space-y-4">
      <p className="text-sm text-gray-600 font-light"><span className="text-gray-900">Address:</span> 10314 Strathmore Hall St Unit 301, Bethesda, MD 20852</p>
      <p className="text-sm text-gray-600 font-light"><span className="text-gray-900">Phone:</span> <a href="tel:18173076735" className="text-gray-600 hover:text-gray-900 transition-colors">817-307-6735</a></p>
